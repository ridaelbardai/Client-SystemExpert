...
class MyFooter extends PdfPageEventHelper {
	...
	public void onEndPage(PdfWriter writer, Document document) {
		...
		ColumnText.showTextAligned(cb, Element.ALIGN_CENTER, header, 20 + document.left(), document.top() + 10, 0);
		ColumnText.showTextAligned(cb, Element.ALIGN_CENTER, footer, document.right() - 50, document.bottom() - 10, 0);
	}
}
...
public class PdfImprimer {
	...
	String text;
	fstm.ilisi.model.Diagnostique diagnostic;

	public PdfImprimer(String t, fstm.ilisi.model.Diagnostique dia) {
		this.text = t;
		this.diagnostic = dia;
	}
	...
	public void makePdf() {
		...
		try {
			...
			chunk = new Chunk("this is a pdf of your diagnostiqye { " + diagnostic.getPatient().getNom() + "  "
					+ diagnostic.getPatient().getPrenom() + " }\n", font);
			chunk.setTextRise(7);
			// doc.add(chunk);
			chunk2 = new Chunk("				Les symptomes sont : " + diagnostic.symptomes + "\n\n", font1);
			chunk2.setTextRise(7);
			// doc.add(chunk2);
			chunk3 = new Chunk("				La possibilité de présence de Covid 19 est  : "
					+ diagnostic.getPossi_presence() + "\n\n", font1);
	...
	public void makePdf1() {
		...
		try {
			...
			//Image image = Image.getInstance("‪C:\\Users\\rb99\\Desktop\\fst.jpeg");
			//Image image1 = Image.getInstance("‪C:\\Users\\rb99\\Desktop\\ilisi.jpeg");
...
//			table.addCell(cell4);
			...
			//Image image3 = Image.getInstance("‪C:\\Users\\rb99\\Desktop\\covid.jpeg");
...
//			table.addCell(cell);
			...
			table.addCell(cell);
			String str = "";
			for (Symptome s : this.diagnostic.symptomes) {
				str += s.getNomSymptome() + "  ";
			}
